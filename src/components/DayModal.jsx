            ...
            currentVotes.map((vote, index) => {
              if (vote.status === "AVAILABLE") {
                return (
                  <div
                    key={index}
                    className="inline-flex items-center bg-[#ffffff] text-sm text-[#333] border px-2.5 py-[5px] rounded-[20px] border-solid border-transparent bg-[#e6ffe6] border-[#000000] before:content-[''] before:inline-block before:w-2.5 before:h-2.5 before:bg-[#28a745] before:mr-2 before:rounded-[50%]"
                     >
                    {
            ...
            currentVotes.map((vote, index) => {
              if (vote.status === "NOT_AVAILABLE") {
                return (
                  <div
                    key={index}
                    className="inline-flex items-center bg-[#ffffff] text-sm text-[#333] border px-2.5 py-[5px] rounded-[20px] border-solid border-transparent bg-[#ffe6e6] border-[#000000] before:content-[''] before:inline-block before:w-2.5 before:h-2.5 before:bg-[#dc3545] before:mr-2 before:rounded-[50%]"
                  >
                    {
                      props.participants.find(
                        (participant) =>
