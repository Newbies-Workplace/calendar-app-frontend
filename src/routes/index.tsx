...
function CreateEventPage() {
  ...
  return (
    <div className="flex min-h-screen h-screen w-screen overflow-hidden">
      <div className="w-1/2 h-full bg-black flex flex-col justify-center items-center overflow-hidden">
        <div className="w-full h-full bg-[url('/tlo.jpg')] bg-center bg-cover blur-lg scale-110"></div>
        <div className="absolute flex flex-col justify-center items-center gap-2">
        <img className="w-1/4 h-1/4" src="/icon.png" alt="tlo" />
        <h1 className="text-white text-4xl font-bold italic">Newbies Calendar</h1></div>
      </div>
      <div className="w-1/2 h-full flex items-center justify-center bg-gray-50 p-10">
        <div className="w-full max-w-md">
          <h1 className="text-black border border-black bg-gray-100 p-4 rounded-lg w-full text-center">Stwórz wydarzenie</h1>
          <form className="text-lg leading-tight" onSubmit={handleSubmit(onSubmit)}>
            <div className="flex flex-col gap-2">
            <label htmlFor="name" className="text-black object-top text-left">Nazwa wydarzenia</label>
              <input
              ...
              />
              {errors.name && <div className="text-red-500 text-sm">Nazwa jest wymagana</div>}

              <label htmlFor="description" className="text-gray-700">Opis wydarzenia</label>
              <textarea
                className="border border-black bg-gray-100 p-2 rounded-lg text-black"
                id="description"
              ...
              />
                ...
                <label htmlFor="voting_end" className="text-black object-top text-left">Czas zakończenia głosowania</label>
              <input
                className="border border-black bg-gray-100 p-2 rounded-lg text-black"
                type="datetime-local"
                id="voting_end"
              ...
              <div className="flex space-x-5 w-full">
                <div className="flex flex-col gap-2 w-1/2">
                  <label htmlFor="start" className="text-black object-top text-left">Początek terminów</label>
                  <input
                    className="border border-black bg-gray-100 p-2 rounded-lg text-black"
                    type="date"
                    id="start"
                ...
                <div className="flex flex-col gap-2 w-1/2">
                  <label htmlFor="end" className="text-black object-top text-left">Koniec terminów</label>
                  <input
                    className="border border-black bg-gray-100 p-2 rounded-lg text-black"
                    type="date"
                    id="end"
              ...
              <label className="text-black object-top text-left" htmlFor={"owner"}>Twój nick</label>
              <input
                id={"owner"}
              ...
              />
              {errors.owner && <div className="text-red-500 text-sm">Twój nick jest wymagany</div>}
